...
if ( (ml_type === "counter") || (ml_type === "counters") ) {
    endpoint_args[0] = __dirname + '/../tools/add_counter_server.js'
} else if ( (ml_type === "wallet") || (ml_type === "wallets") ) {
    endpoint_args[0] = __dirname + '/../tools/add_wallet_server.js'
}
//
